...
namespace FaceGraph {
	public partial class MainForm : Form {
		public MainForm() {
			...
			TrackBarQuality.Value = GraphSettings.Quality;
		...
		private void TrackBarQuality_ValueChanged(object sender, EventArgs e) {
			GraphSettings.Quality = TrackBarQuality.Value;
			UpdateLabels();
		}

		private void RadioCircle_CheckedChanged(object sender, EventArgs e) {
			if(RadioCircle.Checked)
				GraphSettings.PhotoShape = Shape.Circle;
			else
				GraphSettings.PhotoShape = Shape.Square;
		}
